...
class CalendarInvite():
    ...
    def send_invite(self, call) -> None:
        ...
        self.data = {"Name": 'Just me', "Day": 'Sunday', "month_name": 'Jan', "day": '1', "ord": '1st', "time_hour": '11', "time_minutes": '11', "ampm": 'am'} # @FIXME
...
if __name__ == '__main__':
    call = {}
    call['login'] = 'themarsgroup'
    call['from'] = 'themarsgroup@gmail.com'
    call['description'] = 'test email'
    call['attendees'] = ['lostjournals@gmail.com', 'forest@fractalgradient.com']
    call['organizer'] = 'themarsgroup@gmail.com'
    call['Subject'] = 'this is a test'

    cal_date = datetime.date(2020, 1, 15)
    call_time = datetime.time(11, 11)
